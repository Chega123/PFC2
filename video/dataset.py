    ...
    def __getitem__(self, idx):
        ...
        for attempt in range(max_retries):
            try:
                ...
                # Preparar conversación con system, user y assistant
                ...
                # Crear mensajes solo hasta el user (sin assistant)
                user_messages = []
...
def collate_fn(batch):
    ...
    try:
        ...
        print(f"WARNING: No se pudo concatenar pixel_values: {e}")
        pixel_values_tensor = pixel_values

    # Concatenar image_grid_thw
    try:
